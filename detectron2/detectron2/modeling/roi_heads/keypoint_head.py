...
from detectron2.detectron2.layers import Conv2d, ConvTranspose2d, cat, interpolate
from detectron2.detectron2.structures import Instances, heatmaps_to_keypoints
