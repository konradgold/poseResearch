...
from detectron2.detectron2.data import build_detection_test_loader, detection_utils
from detectron2.detectron2.evaluation import (
    COCOEvaluator,
    inference_on_dataset,
    print_csv_format,
)
from detectron2.detectron2.export import (
    STABLE_ONNX_OPSET_VERSION,
    TracingAdapter,
    dump_torchscript_IR,
    scripting_with_instances,
)
from detectron2.detectron2.modeling import GeneralizedRCNN, RetinaNet, build_model
from detectron2.detectron2.modeling.postprocessing import detector_postprocess
from detectron2.detectron2.projects.point_rend import add_pointrend_config
...
def export_caffe2_tracing(cfg, torch_model, inputs):
    from detectron2.detectron2.export import Caffe2Tracer
