...
from detectron2.detectron2.modeling.backbone import build_backbone
...
from detectron2.detectron2.modeling.meta_arch.retinanet import permute_to_N_HWA_K
...
def permute_all_cls_and_box_to_N_HWA_K_and_concat(
    pred_logits, pred_anchor_deltas, num_classes=80
):
    """
