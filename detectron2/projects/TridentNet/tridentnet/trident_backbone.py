...
from detectron2.detectron2.layers import Conv2d, FrozenBatchNorm2d, get_norm
from detectron2.detectron2.modeling import BACKBONE_REGISTRY, ResNet, ResNetBlockBase
from detectron2.detectron2.modeling.backbone.resnet import (
    BasicStem,
    BottleneckBlock,
