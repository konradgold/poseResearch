...
from MotionBERT.train import set_random_seed, save_checkpoint
...
def train_with_config(args, opts):
    ...
    train_dataset = MotionDataset2D(args, args.subset_list, 'train')
    test_dataset = MotionDataset2D(args, args.subset_list, 'test')
