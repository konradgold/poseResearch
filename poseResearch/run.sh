...
python "$SCRIPT_DIR/example_usage.py" 10 --preprocessor yolo_bb --pose2d yolo --pose3d motionbert --yolo-model 11m --video "$SCRIPT_DIR/male1_t4_preview.mp4" --batch-size 20
