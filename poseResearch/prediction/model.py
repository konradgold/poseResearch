...
class GPTConfig:
    ...
    @classmethod
    def from_yaml(cls, yaml_path: str) -> 'GPTConfig':
        try:
...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.transformer.wte.weight = self.lm_head.weight # https://paperswithcode.com/method/weight-tying # type: ignore
    ...
    def forward(self, idx, targets=None):
        ...
        tok_emb = self.transformer.wte(idx) # type: ignore # token embeddings of shape (b, t, n_embd) type: ignore
